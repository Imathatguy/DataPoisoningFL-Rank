...
from federated_learning.utils import shifted_mean
...
if __name__ == '__main__':
    ...
    if DATASET == "FASHION":
        START_EXP_IDX = START_EXP_IDX + 100020000
    elif DATASET == "CIFAR10":
        START_EXP_IDX = START_EXP_IDX + 100060000
    elif DATASET == "MNIST":
        START_EXP_IDX = START_EXP_IDX + 110020000
    elif DATASET == "QMNIST":
        START_EXP_IDX = START_EXP_IDX + 110060000
    else:
